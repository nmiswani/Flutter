...
class ReportDailyTable extends StatefulWidget {
  ...
  @override
  State<ReportDailyTable> createState() => _ReportDailyTableState();
}

class _ReportDailyTableState extends State<ReportDailyTable> {
  ...
  Future<void> _fetchAllProductDetails() async {
    ...
    try {
      while (keepFetching) {
        final url = Uri.parse(
          "${MyServerConfig.server}/pomm/php/load_sales_report_table.php?date=$formattedDate&pageno=$page",
        );
